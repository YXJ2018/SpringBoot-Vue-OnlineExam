...
-- ----------------------------
INSERT INTO `fillquestion` VALUES ('计算机网络', 10000, '从计算机网络系统组成的角度看，计算机网络可以分为()和()', '通信子网资源子网', NULL, 2, '3', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10001, '收发电子邮件，属于ISO/OSI RM中 ()层的功能。', '应用', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10002, '在TCP/IP层次模型中与OSI参考模型第四层相对应的主要协议有()和(),其中后者提供无连接的不可靠传输服', 'TCP（传输控制协议） UDP（用户数据报协议） ', NULL, 2, '2', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10003, '计算机网络中常用的三种有线媒体是 (),()和 ()', '同轴电缆.双绞线 光纤', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10004, '国内最早的四大网络包括原邮电部的ChinaNet. 原电子部的ChinaGBN. 教育部的()和中科院的CSTnet', 'CERnet (或中国教育科研网)', NULL, 2, '4', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10005, '复盖一个国家，地区或几个洲的计算机网络称为()，在同一建筑或复盖几公里内范围的网络称为()，而介于两者之间的是()', ' 广域网       局域网     城域网', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10006, 'Outlook等常用电子邮件软件接收邮件使用的协议是(),发送邮件时使用的协议是()', 'POP3    SMTP    ', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10007, '通信系统中，称调制前的电信号为()信号，调制后的信号为调制信号', '基带', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10008, '按照IPV4标准,IP地址205.3.127.13属于()类地址', 'C', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10009, '计算机网络采用()技术，而传统电话网络则采用()技术', '分组交换电路交换', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10010, '计算机内传输的信号是()，而公用电话系统的传输系统只能传输()', '数字信号模拟信号', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10011, '通信系统中，称调制前的电信号为()，调制后的信号叫()。', '基带信号调制信号', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10012, 'IP地址分()和()两个部分', '网络号主机号', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10013, ' IP地址协议作网间网中()层协议，提供无连接的数据报传输机制，IP数据报也分为()和()两个部分', '网络报头数据区', NULL, 2, '2', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10014, '()是一个简单的远程终端协议。', 'TELNET', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10015, '在同一个系统内，相邻层之间交换信息的连接点称之为()，而低层模块向高层提供功能性的支持称之为()。', '接口服务', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10016, 'Internet广泛使用的电子邮件传送协议是()', 'SMTP', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10017, '按交换方式来分类，计算机网络可以分为电路交换网，  报文交换网  和()三种', '分组交换网', NULL, 2, '3', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10018, 'Intranet分层结构包括网络、(),应用三个层次。', '服务', NULL, 2, '1', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10019, 'WWW上的每一个网页都有一个独立的地址，这些地址称为  ()', '统一资源定位器/URL ', NULL, 2, '2', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10020, '分组交换网中，附加信息用来在网络中进行路由选择、() 和流量控制', '差错纠正  ', NULL, 2, '4', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10021, '根据IEEE802模型的标准将数据链路层划分为LLC子层和 ()子层。', ' MAC ', NULL, 2, '3', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10022, '据交换的路由信息的不同，路由算法可以分为两大类：  ()  和链路状态算法', '距离向量算法', NULL, 2, '3', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10023, '假定某信道受奈氏准则限制的最高码元速率为2000码元/秒。如果采用振幅调制，把码元的振幅划分为16个不同等级来传送，那么可以获得的数据率为 () b/s。', '80000 ', NULL, 2, '5', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10024, '交换型以太网系统中的 ()  ，以其为核心联接站点或者网段，端口之间帧的输入和输出已不再受到CSMA/CD媒体访问控制协议的约束。', '以太网交换器 ', NULL, 2, '5', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10025, '局域网络参考模型是以 ()标准为基础的', 'IEEE802', NULL, 2, '5', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10026, '路由器的核心是 () 。', ' 路由表', NULL, 2, '3', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10027, '若 HDLC 帧数据段中出现比特串“ 01011111110 ”，则比特填充后的输出为()', '10111110110', NULL, 2, '5', NULL);
INSERT INTO `fillquestion` VALUES ('计算机网络', 10028, '数字调制的三种基本形式：移幅键控法ASK、 ()、移相键控法PSK', '移频键控法FSK', NULL, 2, '5', NULL);
...
-- ----------------------------
INSERT INTO `judgequestion` VALUES ('计算机网络', 10001, '与有线网相比,无线网的数据传输率一般相对较慢', 'T', NULL, 2, '1', '');
INSERT INTO `judgequestion` VALUES ('计算机网络', 10002, 'OSI参考模型中,不同节点的同等层具有不同的功能', 'F', NULL, 2, '1', NULL);
INSERT INTO `judgequestion` VALUES ('计算机网络', 10003, '普通电脑不能作为服务器', 'F', NULL, 2, '1', NULL);
INSERT INTO `judgequestion` VALUES ('计算机网络', 10004, '没有网线的电脑不能连入互联网', 'F', NULL, 2, '1', NULL);
INSERT INTO `judgequestion` VALUES ('计算机网络', 10005, '网卡必须安装驱动程序', 'T', NULL, 2, '2', NULL);
INSERT INTO `judgequestion` VALUES ('计算机网络', 10006, 'UTP为屏蔽双绞线', 'F', NULL, 2, '2', NULL);
INSERT INTO `judgequestion` VALUES ('计算机网络', 10007, '网络接口卡又称为网卡,它是构成网络的基本部件', 'T', NULL, 2, '2', NULL);
INSERT INTO `judgequestion` VALUES ('计算机网络', 10008, '无线AP可以成倍地扩展网络覆盖范围', 'T', NULL, 2, '3', NULL);
INSERT INTO `judgequestion` VALUES ('计算机网络', 10009, 'SMTP是一组用于由源地址到目的地址传送邮件的协议', 'T', NULL, 2, '4', NULL);
INSERT INTO `judgequestion` VALUES ('计算机网络', 10010, '任务管理器可以关闭所有的进程', 'F', NULL, 2, '3', NULL);
INSERT INTO `judgequestion` VALUES ('计算机网络', 10011, '利用BT下载时,用户越多,下载速度越快', 'T', NULL, 2, '2', NULL);
INSERT INTO `judgequestion` VALUES ('计算机网络', 10012, 'INTERNET上向朋友发送电子邮件,必须知道对方的真实姓名和家庭住址', 'F', NULL, 2, '1', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '留言表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '回复表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '成绩管理表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES (2, 20190001, 20154084, '计算机网络', NULL, 10, NULL, '2019-04-01');
INSERT INTO `score` VALUES (3, 20190001, 20154084, '计算机网络', NULL, 16, NULL, '2019-04-02');
INSERT INTO `score` VALUES (4, 20190001, 20154084, '计算机网络', NULL, 70, NULL, '2019-04-03');
INSERT INTO `score` VALUES (5, 20190001, 20154084, '计算机网络', NULL, 2, NULL, '2019-04-02');
INSERT INTO `score` VALUES (6, 20190001, 20154084, '计算机网络', NULL, 10, NULL, '2019-04-01');
INSERT INTO `score` VALUES (7, 20190001, 20154084, '计算机网络', NULL, 40, NULL, '2019-04-05');
INSERT INTO `score` VALUES (8, 20190001, 20154084, '计算机网络', NULL, 26, NULL, '2019-04-06');
INSERT INTO `score` VALUES (9, 20190001, 20154084, '计算机网络', NULL, 6, NULL, '2019-04-09');
