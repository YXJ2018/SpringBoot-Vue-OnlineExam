...
<template>
  <div class="exam">
    <el-table :data="pagination.records" border stripe>
      ...
      <el-table-column prop="institute" label="所属学院"></el-table-column>
      ...
      <el-table-column prop="type" label="试卷类型"></el-table-column>
      <el-table-column prop="tips" label="考生提示"></el-table-column>
      <el-table-column fixed="right" label="操作" width="150">
        <template slot-scope="scope">
          <el-button @click="edit(scope.row.examCode)" type="text" size="small">编辑</el-button>
